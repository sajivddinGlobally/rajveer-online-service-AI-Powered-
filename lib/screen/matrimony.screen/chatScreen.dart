...
import '../../data/providers/chatProvider.dart';
...
class _ChatingPageState extends ConsumerState<ChatingPage>
  ...
  void initState() {
    ...
    channel = WebSocketChannel.connect(
      ...
      Uri.parse("wss://api.rajveerfacility.in/matrimonies/chat/ws/$userid"),
    );
        ...
        return StatefulBuilder(
          builder: (context, setStateDialog) {
            return AlertDialog(
              ...
              title: Text("Report", style: GoogleFonts.inter(fontWeight: FontWeight.bold)),
              content: TextField(
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Icon(Icons.arrow_back_ios, color: Colors.white, size: 22.w),
                        ),
                      ),
                    ),
                    Spacer(),
                    Text(widget.name, style: GoogleFonts.roboto(fontSize: 20.sp, fontWeight: FontWeight.w600, color: Colors.white)),
                    Spacer(),
                    ...
                    children: [
                      Expanded(
                        child: RefreshIndicator(
                          onRefresh: () async {
                            await ref.refresh(chatHistoryController(widget.otherUesrid).future);
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final prevDate = index > 0 ? DateTime.parse(sortedMessages[index - 1].timestamp!) : null;
                              final showHeader = prevDate == null ||
                                  DateFormat('yyyy-MM-dd').format(prevDate) != DateFormat('yyyy-MM-dd').format(date);
                                ...
                                children: [
                                  if (showHeader)
                                    Padding(
                                      ...
                                      child: Text(_formatDateHeader(date, DateTime.now()),
                                          style: GoogleFonts.dmSans(fontSize: 12.sp, fontWeight: FontWeight.w600, color: Colors.grey)),
                                    ),
                                  ChatBubble(
                                    message: msg.message!,
      ...
      child: Row(
        children: [
          Expanded(
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(100.r), borderSide: BorderSide(color: Color(0xFF97144d))),
                hintText: "Type a message ...",
                hintStyle: GoogleFonts.inter(fontSize: 16.sp, fontWeight: FontWeight.w600, color: Color(0xFFC8C8C8)),
              ),
            ),
          ),
          SizedBox(width: 10.w),
          GestureDetector(
            onTap: onSend,
            child: Container(
              width: 53.w, height: 53.h,
              decoration: BoxDecoration(shape: BoxShape.circle, color: Color(0xFF97144d)),
...
class ChatBubble extends StatelessWidget {
  ...
  const ChatBubble({super.key, required this.message, required this.isSender, required this.dateTime});
    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: isSender ? Color(0xFF97144d) : Colors.white,
        ...
        child: Column(
          ...
          children: [
            Text(message,
                style: GoogleFonts.roboto(fontSize: 16.sp, color: isSender ? Colors.white : Color(0xFF2B2B2B))),
            SizedBox(height: 4.h),
            Text(_formatTime(dateTime),
                style: GoogleFonts.dmSans(fontSize: 10.sp, color: isSender ? Colors.white70 : Colors.grey.shade600)),
          ],
        ),
      ),
    );
